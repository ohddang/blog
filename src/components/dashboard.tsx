export default function DashBoard() {
  return (
    <div className="w-10/12 h-screen flex justify-center items-center relative">
      ...
      <div className="w-42 h-full flex flex-row items-end text-xs sm:text-base lg:text-lg xl:text-xl font-bold gap-1 absolute bottom-10 left-10 z-10 ">
        <div className="w-full p-2 rounded bg-white/50 flex flex-col gap-1 sm:gap-3 lg:gap-5 relative">
