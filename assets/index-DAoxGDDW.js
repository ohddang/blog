...
`].filter(Zs).join(`
`)),o=sf(o),o=jp(o,n),o=Yp(o,n),a=sf(a),a=jp(a,n),a=Yp(a,n),o=$p(o),a=$p(a),n.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+c);const g=v+p+o,y=v+c+a,R=Wp(r,r.VERTEX_SHADER,g),A=Wp(r,r.FRAGMENT_SHADER,y);r.attachShader(x,R),r.attachShader(x,A),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function T(I){if(t.debug.checkShaderErrors){const X=r.getProgramInfoLog(x).trim(),D=r.getShaderInfoLog(R).trim(),$=r.getShaderInfoLog(A).trim();let Y=!0,ne=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(Y=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,R,A);else{const te=Xp(r,R,"vertex"),P=Xp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
